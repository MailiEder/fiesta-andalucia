...
export default function Home() {
  ...
  const [ergebnisse]  = useFetch("http://localhost:3000/api/single");
  const [menergebnisse] = useFetch("http://localhost:3000/api/singlemen");
  const [teamergebnissewomen] = useFetch("http://localhost:3000/api/teamwoman");
  const [teamergebnisse] = useFetch("http://localhost:3000/api/team");
